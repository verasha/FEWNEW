...
def log_density(params):
    ...
    for i in range(n_samples):
        ...
        log_likes[i] = 3*loglike

    return log_likes

print("Change to 3*logden (hotter)")
...
# Load saved sampler
state_path = './intrinsic_ffunc_1mth_snr5_alpha_resumed/sampler_state.pkl'
...
more_iters = int(1e5)
out_dir = './intrinsic_ffunc_1mth_snr5_alpha_resumed/'
