...
Usage:
  python resume_intrinsic_ffunc_3mth_faceon.py
"""
...
# Load saved sampler
state_path = './intrinsic_ffunc_3mth_snr32_run4/sampler_state.pkl'
print(f'Loading sampler state from: {state_path}')

if not os.path.isfile(state_path):
    print(f"Sampler state not found at: {state_path}")
    print("Please run intrinsic_ffunc_3mth_faceon.py first.")
    exit(1)
...
more_iters = int(1e5)
out_dir = './intrinsic_ffunc_3mth_snr32_run4_resumed/'
