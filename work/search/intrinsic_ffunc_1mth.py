...
def prior_transform(u):
    ...
    # broaden wider
    logm1lim = [param_true[0] - 100*sigmas[0], param_true[0] + 100*sigmas[0]]
    logm2lim = [param_true[1] - 500*sigmas[1], param_true[1] + 500*sigmas[1]]
    alim = [param_true[2] - 300*sigmas[2], param_true[2] + 300*sigmas[2]]
    p0lim = [param_true[3] - 100*sigmas[3], param_true[3] + 100*sigmas[3]]
    e0lim = [param_true[4] - 200*sigmas[4], param_true[4] + 200*sigmas[4]]
...
sampler.run_sampling(
    ...
    savepath='./intrinsic_ffunc_1mth_10xlogden_multi_gen/',
