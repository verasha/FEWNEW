...
def prior_transform(u):
    n=1000
    sigma = 1e-5
    logm1lim = [param_true[0] - n*sigma, param_true[0] + n*sigma]
    logm2lim = [param_true[1] - n*sigma, param_true[1] + n*sigma]
    alim = [param_true[2] - n*sigma, min(param_true[2] + n*sigma, 0.999)]  # a must be <1
    p0lim = [param_true[3] - n*sigma, param_true[3] + n*sigma]
    e0lim = [param_true[4] - n*sigma, param_true[4] + n*sigma]
