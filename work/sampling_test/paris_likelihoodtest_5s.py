...
def prior_transform(u):
    logm1lim = [5.9999244248e+00, 6.0000755752e+00]
    logm2lim = [1.4770759039e+00, 1.4771666055e+00]
    alim = [6.9986572680e-01, 7.0013427320e-01]
    p0lim = [7.4992613407e+00, 7.5007386593e+00]
    e0lim = [3.9996501895e-01, 4.0003498105e-01]
    distlim = [1.9545538472e+00, 2.0454461528e+00]
    cosqSlim = [8.5626502460e-01, 8.9890009918e-01]
    phiSlim = [9.6250763700e-01, 1.0374923630e+00]
    Phiphilim = [3.7054327000e-01, 4.2945673000e-01]
    Phirlim = [4.8585371442e-01, 5.1414628558e-01]
...
config = parismc.SamplerConfig(
    ...
    exclude_scale_z=10,           # NOTE: default np.inf 
