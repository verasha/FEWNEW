...
def prior_transform(u):
    ...
    # logm1lim = [5.999999946489075, 6.000000053510925]
    # logm2lim = [1.477120956636667, 1.4771215528026578]
    # alim = [0.6999993767274207, 0.7000006232725792] #[0.6999993767274225, 0.7000006232725774]
    # p0lim = [7.499999437916994, 7.500000562083006]
    # e0lim = [0.39999977170770384, 0.4000002282922962]
    # distlim = [0.4860386493238116, 0.5139613506761884]
    # cosqSlim =  [0.8702397352956238, 0.8849253884851217]
    # phiSlim = [0.9855342921219667, 1.0144657078780333]
    # Phiphilim = [0.38728579253388856, 0.4127142074661115]
    # Phirlim = [0.484683807978082, 0.515316192021918]
    ...
    # 10 sigma
    # logm1lim = [5.999186553343646, 6.000813446656354]
    # logm2lim = [1.4766739100079498, 1.477568599431375]
    # alim = [0.6985457864293411, 0.7014542135706588]
    # p0lim = [7.491909897094295, 7.508090102905705]
    # e0lim = [0.399646914721015, 0.40035308527898505]
    # distlim = [0.39041268197405565, 0.6095873180259443]
    # cosqSlim = [0.677431743902101, 1.0] #upper limit of cosqS is 1
    # phiSlim = [0.6359934971278849, 1.3640065028721151]
    # Phiphilim = [0.05700391540851629, 0.7429960845914838]
    # Phirlim = [0.2916475564872404, 0.7083524435127596]

    # YA ALLAHHH BISMILLAH
    # 2.5 SIGMA
    logm1lim = [5.999796638335912, 6.000203361664088]
    logm2lim = [1.4770094185417342, 1.4772330908975906]
    alim = [0.6996364466073353, 0.7003635533926647]
    p0lim = [7.497977474273574, 7.502022525726426]
    e0lim = [0.39991172868025376, 0.4000882713197463]
    distlim = [0.4726031704935139, 0.527396829506486]
    cosqSlim = [0.8275448573933049, 0.9276202663874407]
    phiSlim = [0.9089983742819713, 1.0910016257180288]
    Phiphilim = [0.3142509788521291, 0.48574902114787094]
    Phirlim = [0.4479118891218101, 0.5520881108781899]
...
# external_lhs_points = np.array([param_true])
# external_lhs_log_densities = loglike(external_lhs_points)
...
sampler.run_sampling(
    ...
    savepath='./paris_likelihoodtest_25s/',
